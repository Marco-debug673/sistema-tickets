...
public class Inc_VentasController : Controller
{
    private readonly AppDbContext _context;
    private readonly IWebHostEnvironment _env;

    public Inc_VentasController(AppDbContext context, IWebHostEnvironment env)
    {
        _context = context;
        _env = env;
    }
    ...
    [HttpGet]
    public IActionResult solicitud_incadea_ventas()
    {
        ViewBag.Usuario = HttpContext.Session.GetString("Usuario");
        if (string.IsNullOrEmpty(ViewBag.Usuario)) return RedirectToAction("Index", "Home");
        
        return View("~/Views/Home/solicitud_incadea_ventas.cshtml");
    }

    [HttpPost]
    public async Task<IActionResult> GuardarIncVentas(Incadea incadea, List<IFormFile> evidenciaFiles)
    {
        ...
        )
        {
            ...
            return View("~/Views/Home/solicitud_incadea_ventas.cshtml", incadea);
        }
        ...
        try
        {
            ...
            TempData["SuccessMessage"] = "Solicitud de Incadea del área de ventas ha sido registrada correctamente.";
            return RedirectToAction("solicitud_incadea_ventas", "Inc_Ventas");
        }
        catch (Exception ex)
        {
