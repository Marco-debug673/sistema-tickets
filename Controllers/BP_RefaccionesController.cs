...
public class BP_RefaccionesController : Controller
{
    private readonly AppDbContext _context;
    private readonly IWebHostEnvironment _env;

    public BP_RefaccionesController(AppDbContext context, IWebHostEnvironment env)
    {
        _context = context;
        _env = env;
    }
    ...
    [HttpGet]
    public IActionResult solicitud_bp_refacciones()
    {
        ViewBag.Usuario = HttpContext.Session.GetString("Usuario");
        if (string.IsNullOrEmpty(ViewBag.Usuario)) return RedirectToAction("Index", "Home");
        
        return View("~/Views/Home/solicitud_bp_refacciones.cshtml");
    }

    [HttpPost]
    public async Task<IActionResult> GuardarBPRefacciones(BusinessPro business_pro, List<IFormFile> evidenciaFiles)
    {
        ...
        )
        {
            ...
            return View("~/Views/Home/solicitud_bp_refacciones.cshtml", business_pro);
        }
        ...
        try
        {
            ...
            business_pro.area = "Refacciones";
            _context.BusinessPro.Add(business_pro);
            await _context.SaveChangesAsync();

            TempData["SuccessMessage"] = "Solicitud de Business Pro del área de refacciones ha sido registrada correctamente.";
            return RedirectToAction("solicitud_bp_refacciones", "BP_Refacciones");
        }
        catch (Exception ex)
        {
